...
var $author$project$Main$Model = F5(
	function (baseUrl, key, url, error, clusters) {
		return {baseUrl: baseUrl, clusters: clusters, error: error, key: key, url: url};
	});
var $author$project$Main$Models$ClusterDetailsDTO = F4(
	function (id, name, kafkaHosts, schemaRegistryUrl) {
		return {id: id, kafkaHosts: kafkaHosts, name: name, schemaRegistryUrl: schemaRegistryUrl};
	});
var $author$project$Main$initClusters = _List_fromArray(
	[
		A4($author$project$Main$Models$ClusterDetailsDTO, 'id', 'name', 'hosts', 'schema')
	]);
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A5($author$project$Main$Model, flags.baseUrl, key, url, $elm$core$Maybe$Nothing, $author$project$Main$initClusters),
				...
				_List_Nil,
				{
					columns: _List_fromArray(
						[
							...
							view: function (c) {
								return $mdgriffith$elm_ui$Element$text(c.id);
							},
							...
							view: function (c) {
								return $mdgriffith$elm_ui$Element$text(c.name);
							},
							width: $mdgriffith$elm_ui$Element$fillPortion(3)
						},
							{
							header: $mdgriffith$elm_ui$Element$text('Hosts'),
							view: function (c) {
								return $mdgriffith$elm_ui$Element$text(c.kafkaHosts);
							},
							width: $mdgriffith$elm_ui$Element$fillPortion(3)
						},
							{
							header: $mdgriffith$elm_ui$Element$text('Schema Registry'),
							view: function (c) {
								return $mdgriffith$elm_ui$Element$text(c.schemaRegistryUrl);
							},
							width: $mdgriffith$elm_ui$Element$fillPortion(3)
						}
						]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 123, 182, 105)),
...
var $author$project$Main$rowContent = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				_Debug_todo(
					'Main',
					{
						start: {line: 95, column: 19},
						end: {line: 95, column: 29}
					})),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
			]),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$rowContent(model),
